...
public class PlayActivity extends AppCompatActivity {
    ...
    private String JvmpUrl = "jvmp://121.36.92.161:7070/live/2102412464WLL4007607?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjaGFubmVsX2lkIjowLCJkZXZpY2VfaWQiOiIyMTAyNDEyNDY0V0xMNDAwNzYwNyIsImV4cGlyZV90aW1lIjoxNjEyNDg2MjE4LCJzdHJlYW1fdHlwZSI6MCwidXNlcl9pZCI6IjE3NDM2NzE3MDcyMDIxMDEyNjE0NTcwMCIsInVzZXJfdHlwZSI6IkVOVEVSUFJJU0UifQ.ZdIB5BrnNiG54nnvdvaF-HtnLjW_Bk8i0h08k5FXljw";
...
//        JniUtil.connect(,JvmpUrl);
         ...
         * 建立连接
         */
        int playId = Jni.holosensPlayerConnect(JvmpUrl, 0, 1);
    ...
    private void initHoloPlayer() {
        JniUtil.holosensPlayerInit(MyApp.getInstance());
        MyApp.getInstance().playerIdWindowMap.clear();
